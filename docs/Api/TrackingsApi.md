...
# **postbackTest**
> \Swagger\Client\Model\InlineResponse20014 postbackTest($id, $destinationId, $catalogId, $clickId, $subId, $subId2, $subId3)
...
# **trackingsAdd**
> \Swagger\Client\Model\InlineResponse20012 trackingsAdd($catalogId, $type, $data)
...
# **trackingsDelete**
> \Swagger\Client\Model\InlineResponse2001 trackingsDelete($id)
...
# **trackingsGet**
> \Swagger\Client\Model\InlineResponse20011 trackingsGet($catalogId)
...
# **trackingsUpdate**
> \Swagger\Client\Model\InlineResponse20013 trackingsUpdate($id, $data)
