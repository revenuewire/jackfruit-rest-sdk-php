...
class DashboardApi
{
    ...
    /**
     * Operation dashboardCustomizationPost
     *
     * 
     *
     * @param \Swagger\Client\Model\Setting[] $items Dashboard customization setting item list (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Response
     */
    public function dashboardCustomizationPost($items = null)
    {
        list($response) = $this->dashboardCustomizationPostWithHttpInfo($items);
        return $response;
    }

    /**
     * Operation dashboardCustomizationPostWithHttpInfo
     *
     * 
     *
     * @param \Swagger\Client\Model\Setting[] $items Dashboard customization setting item list (optional)
     ...
     */
    public function dashboardCustomizationPostWithHttpInfo($items = null)
    {
        // parse inputs
        $resourcePath = "/dashboard/customization";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
