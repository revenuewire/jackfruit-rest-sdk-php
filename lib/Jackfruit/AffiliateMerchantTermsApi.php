...
/**
 * AffiliateMerchantTermsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AffiliateMerchantTermsApi
{
    /**
     * API Client
     *
     ...
     *
     * @return AffiliateMerchantTermsApi
     */
    ...
    /**
     * Operation affiliateMerchantTermsAdd
     *
     * 
     *
     * @param int $merchantTermId Merchant Term ID (required)
     * @param int $affiliateAccountId Affiliate Group Account ID (internal use only) (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\InlineResponse2001
     */
    public function affiliateMerchantTermsAdd($merchantTermId, $affiliateAccountId = null)
    {
        list($response) = $this->affiliateMerchantTermsAddWithHttpInfo($merchantTermId, $affiliateAccountId);
        return $response;
    }

    /**
     * Operation affiliateMerchantTermsAddWithHttpInfo
     *
     * 
     *
     * @param int $merchantTermId Merchant Term ID (required)
     ...
     */
    public function affiliateMerchantTermsAddWithHttpInfo($merchantTermId, $affiliateAccountId = null)
    {
        // verify the required parameter 'merchantTermId' is set
        if ($merchantTermId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $merchantTermId when calling affiliateMerchantTermsAdd');
        }
        // parse inputs
        $resourcePath = "/affiliatemerchantterms";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        // query params
        if ($merchantTermId !== null) {
            $queryParams['merchantTermId'] = $this->apiClient->getSerializer()->toQueryValue($merchantTermId);
        }
        // query params
