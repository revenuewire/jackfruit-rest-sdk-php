...
/**
 * CPAAcceptTermsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class CPAAcceptTermsApi
{
    ...
    /**
     * Operation cpaTermsAccept
     *
     * 
     *
     * @param int $payoutPolicyId CPA Payout Policy ID (required)
     * @param int $affiliateAccountId Affiliate Group Account ID (internal use only) (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\InlineResponse2001
     */
    public function cpaTermsAccept($payoutPolicyId, $affiliateAccountId = null)
    {
        list($response) = $this->cpaTermsAcceptWithHttpInfo($payoutPolicyId, $affiliateAccountId);
        return $response;
    }

    /**
     * Operation cpaTermsAcceptWithHttpInfo
     *
     * 
     *
     * @param int $payoutPolicyId CPA Payout Policy ID (required)
     ...
     */
    public function cpaTermsAcceptWithHttpInfo($payoutPolicyId, $affiliateAccountId = null)
    {
        // verify the required parameter 'payoutPolicyId' is set
        if ($payoutPolicyId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payoutPolicyId when calling cpaTermsAccept');
        }
        // parse inputs
        $resourcePath = "/cpaapplytorun/{payoutPolicyId}/accept";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        if ($payoutPolicyId !== null) {
            $resourcePath = str_replace(
                "{" . "payoutPolicyId" . "}",
                $this->apiClient->getSerializer()->toPathValue($payoutPolicyId),
                $resourcePath
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/cpaapplytorun/{payoutPolicyId}/accept'
            );
