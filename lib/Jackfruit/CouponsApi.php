...
class CouponsApi
{
     ...
     */
    public function couponsGet($catalogId)
    {
        list($response) = $this->couponsGetWithHttpInfo($catalogId);
        return $response;
    }
     ...
     */
    public function couponsGetWithHttpInfo($catalogId)
    {
        // verify the required parameter 'catalogId' is set
        if ($catalogId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $catalogId when calling couponsGet');
        }
        // parse inputs
