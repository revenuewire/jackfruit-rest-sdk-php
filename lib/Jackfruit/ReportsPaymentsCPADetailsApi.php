...
/**
 * ReportsPaymentsCPADetailsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportsPaymentsCPADetailsApi
{
    /**
     * API Client
     *
     ...
     *
     * @return ReportsPaymentsCPADetailsApi
     */
     ...
     * @param \Swagger\Client\Model\Sort3 $sort A JSON encoded object with the column to sort on and the sort direction (eg. {\&quot;col\&quot;:\&quot;id\&quot;,\&quot;dir\&quot;:\&quot;DESC\&quot;}) (required)
     * @param string $payments A payment fid (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\PaymentsDetailsCpaDatas
     */
    public function reportPaymentsCpa($pagination, $sort, $payments)
    {
        list($response) = $this->reportPaymentsCpaWithHttpInfo($pagination, $sort, $payments);
        return $response;
    }
     ...
     * @param string $payments A payment fid (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\PaymentsDetailsCpaDatas, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportPaymentsCpaWithHttpInfo($pagination, $sort, $payments)
    {
        ...
        // parse inputs
        $resourcePath = "/reports/payments/details/cpa";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
// body params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentsDetailsCpaDatas',
                '/reports/payments/details/cpa'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentsDetailsCpaDatas', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentsDetailsCpaDatas', $e->getResponseHeaders());
     ...
     */
    public function reportPaymentsCpa_0($pagination, $sort, $payments)
    {
        list($response) = $this->reportPaymentsCpa_0WithHttpInfo($pagination, $sort, $payments);
        return $response;
    }
     ...
     */
    public function reportPaymentsCpa_0WithHttpInfo($pagination, $sort, $payments)
    {
        // verify the required parameter 'pagination' is set
        if ($pagination === null) {
        ...
        // parse inputs
        $resourcePath = "/reports/payments/details/cpa/totals";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
// body params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/reports/payments/details/cpa/totals'
            );
     ...
     */
    public function reportsPaymentsCount($pagination, $sort, $payments)
    {
        list($response) = $this->reportsPaymentsCountWithHttpInfo($pagination, $sort, $payments);
        return $response;
    }
     ...
     */
    public function reportsPaymentsCountWithHttpInfo($pagination, $sort, $payments)
    {
        // verify the required parameter 'pagination' is set
        if ($pagination === null) {
        ...
        // parse inputs
        $resourcePath = "/reports/payments/details/cpa/count";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
// body params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/reports/payments/details/cpa/count'
            );
     ...
     */
    public function reportsPaymentsExport($pagination, $sort, $payments)
    {
        list($response) = $this->reportsPaymentsExportWithHttpInfo($pagination, $sort, $payments);
        return $response;
    }
     ...
     */
    public function reportsPaymentsExportWithHttpInfo($pagination, $sort, $payments)
    {
        // verify the required parameter 'pagination' is set
        if ($pagination === null) {
        ...
        // parse inputs
        $resourcePath = "/reports/payments/details/cpa/export";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
// body params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/reports/payments/details/cpa/export'
            );
