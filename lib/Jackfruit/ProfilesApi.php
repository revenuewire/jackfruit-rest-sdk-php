...
class ProfilesApi
{
    ...
    /**
     * Operation profilesSaveAppConfigPut
     *
     * 
     *
     ...
     */
    public function profilesSaveAppConfigPut($app, $config)
    {
        list($response) = $this->profilesSaveAppConfigPutWithHttpInfo($app, $config);
        return $response;
    }

    /**
     * Operation profilesSaveAppConfigPutWithHttpInfo
     *
     * 
     *
     * @param string $app The application name (required)
     ...
     */
    public function profilesSaveAppConfigPutWithHttpInfo($app, $config)
    {
        // verify the required parameter 'app' is set
        if ($app === null) {
            throw new \InvalidArgumentException('Missing the required parameter $app when calling profilesSaveAppConfigPut');
        }
        // verify the required parameter 'config' is set
        if ($config === null) {
            throw new \InvalidArgumentException('Missing the required parameter $config when calling profilesSaveAppConfigPut');
        }
        // parse inputs
        $resourcePath = "/profiles/save-app-config";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
