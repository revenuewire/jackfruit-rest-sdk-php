...
/**
 * AffiliateLinkerLinksApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class AffiliateLinkerLinksApi
{
     ...
     *
     * @return AffiliateLinkerLinksApi
     */
    ...
    /**
     * Operation affiliateLinksGet
     *
     * 
     *
     * @param string $catalogFid Offer&#39;s catalog FID (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\InlineResponse200
     */
    public function affiliateLinksGet($catalogFid = null)
    {
        list($response) = $this->affiliateLinksGetWithHttpInfo($catalogFid);
        return $response;
    }

    /**
     * Operation affiliateLinksGetWithHttpInfo
     *
     * 
     *
     * @param string $catalogFid Offer&#39;s catalog FID (optional)
     ...
     */
    public function affiliateLinksGetWithHttpInfo($catalogFid = null)
    {
        // parse inputs
        $resourcePath = "/affiliatelinks";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
