...
class DefaultApi
{
     ...
     */
    public function geoInfoCountriesCountryCodeStatesGet($country_code)
    {
        list($response) = $this->geoInfoCountriesCountryCodeStatesGetWithHttpInfo($country_code);
        return $response;
    }
     ...
     */
    public function geoInfoCountriesCountryCodeStatesGetWithHttpInfo($country_code)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $country_code when calling geoInfoCountriesCountryCodeStatesGet');
        }
        // parse inputs
