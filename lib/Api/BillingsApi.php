...
class BillingsApi
{
     ...
     * @return \Swagger\Client\Model\BillInfo
     */
    public function billingInfoUpdatePaypal($billingInfoId, $ppToken = null, $token = null)
    {
        list($response) = $this->billingInfoUpdatePaypalWithHttpInfo($billingInfoId, $ppToken, $token);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\BillInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function billingInfoUpdatePaypalWithHttpInfo($billingInfoId, $ppToken = null, $token = null)
    {
        // verify the required parameter 'billingInfoId' is set
        if ($billingInfoId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $billingInfoId when calling billingInfoUpdatePaypal');
        }
        // parse inputs
        $resourcePath = "/billings/{billingInfoId}/update-paypal";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\BillInfo',
                '/billings/{billingInfoId}/update-paypal'
            );
