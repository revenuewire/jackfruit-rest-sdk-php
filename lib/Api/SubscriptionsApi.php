...
class SubscriptionsApi
{
     ...
     * 
     *
     * @param int $recurring_transaction_item_id Recurring transaction item id (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Response[]
     */
    public function subscriptionsRecurringTransactionItemIdCancelPut($recurring_transaction_item_id)
    {
        list($response) = $this->subscriptionsRecurringTransactionItemIdCancelPutWithHttpInfo($recurring_transaction_item_id);
        return $response;
    }
     ...
     */
    public function subscriptionsRecurringTransactionItemIdCancelPutWithHttpInfo($recurring_transaction_item_id)
    {
        // verify the required parameter 'recurring_transaction_item_id' is set
        if ($recurring_transaction_item_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $recurring_transaction_item_id when calling subscriptionsRecurringTransactionItemIdCancelPut');
        }
        // parse inputs
        ...
        if ($recurring_transaction_item_id !== null) {
            $resourcePath = str_replace(
                ...
                $this->apiClient->getSerializer()->toPathValue($recurring_transaction_item_id),
                $resourcePath
            );
        }
