...
class Deployment implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['data'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'data', must be one of 'OK', 'FAILED'.";
        }
    ...
    {
        $allowed_values = array('OK', 'FAILED');
        if ((!in_array($data, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'data', must be one of 'OK', 'FAILED'");
        }
