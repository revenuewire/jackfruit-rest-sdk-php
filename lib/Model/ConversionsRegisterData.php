...
/**
 * ConversionsRegisterData Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ConversionsRegisterData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConversionsRegisterData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['browser'] === null) {
            $invalid_properties[] = "'browser' can't be null";
        }
